...
class OrdersControllerTest {
    ...
    void testShowNewOrderForm() throws Exception {
        mockMvc.perform(get("/admin/orders/add"))
                .andExpect(status().isOk())
                .andExpect(view().name("admin/order/newOrder"))
    ...
    void testSearchClient_Success() throws Exception {
        ...
        mockMvc.perform(post("/admin/orders/search-client")
                        .with(csrf())
    ...
    void testDeleteOrder_Success() throws Exception {
        mockMvc.perform(get("/admin/orders/1/delete"))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/admin/orders?page=0"));
    ...
    void testEditOrder_Success() throws Exception {
        ...
        mockMvc.perform(get("/admin/orders/1/edit"))
                .andExpect(status().isOk())
                .andExpect(view().name("admin/order/editOrder"))
    ...
    void testChoiceAppliance_Success() throws Exception {
        ...
        mockMvc.perform(get("/admin/orders/1/choice-appliance"))
                .andExpect(status().isOk())
                .andExpect(view().name("admin/order/choiceAppliance"))
    ...
    void testAddIntoOrder_Success() throws Exception {
        mockMvc.perform(post("/admin/orders/1/add-into-order")
                        .with(csrf())
                        .param("applianceId", "1")
                        .param("numbers", "5"))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/admin/orders/1/edit"));
    ...
    void testApproveOrder_Success() throws Exception {
        mockMvc.perform(get("/admin/orders/1/approved"))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/admin/orders?page=0"));
    ...
    void testUnapproveOrder_Success() throws Exception {
        mockMvc.perform(get("/admin/orders/1/unapproved"))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/admin/orders?page=0"));
    ...
    void testDeleteOrderRow_Success() throws Exception {
        mockMvc.perform(get("/admin/orders/1/edit/row/1/delete"))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/admin/orders/1/edit"));
