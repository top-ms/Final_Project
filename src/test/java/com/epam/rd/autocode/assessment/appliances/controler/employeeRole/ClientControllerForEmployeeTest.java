...
@WebMvcTest(ClientControllerForEmployee.class)
class ClientControllerForEmployeeTest {
    ...
    void testViewListOfClients_Success() throws Exception {
        ...
        mockMvc.perform(get("/employee/clients"))
                .andExpect(status().isOk())
                .andExpect(view().name("employee/client/clients"))
    ...
    void testSearchClients_Success() throws Exception {
        ...
        mockMvc.perform(get("/employee/clients/search")
    ...
    void testSearchClients_EmptyEmail() throws Exception {
        mockMvc.perform(get("/employee/clients/search")
                ...
                .andExpect(redirectedUrl("/employee/clients"));
    }

    @Test
    @WithMockUser(username = "employee@test.com", authorities = {"ROLE_EMPLOYEE"})
    void testShowFormForAddingClient() throws Exception {
        mockMvc.perform(get("/employee/clients/add"))
                .andExpect(status().isOk())
                .andExpect(view().name("employee/client/newClient"))
    ...
    void testAddNewClient_Success() throws Exception {
        ...
        mockMvc.perform(post("/employee/clients/add-client")
                        .with(csrf())
                        .param("name", "New Client")
                        .param("email", "newclient@test.com")
                        .param("password", "password123"))
    ...
    void testDeleteClient_Success() throws Exception {
        mockMvc.perform(get("/employee/clients/1/delete"))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/employee/clients?page=0"));
    ...
    void testDeleteClient_WithPage() throws Exception {
        mockMvc.perform(get("/employee/clients/1/delete")
                        .param("page", "2"))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/employee/clients?page=2"));
    ...
    void testShowEditClientForm_Success() throws Exception {
        ...
        mockMvc.perform(get("/employee/clients/1/edit"))
                .andExpect(status().isOk())
                .andExpect(view().name("employee/client/editClient"))
                .andExpect(model().attributeExists("client"))
    ...
    void testUpdateClient_ClientNotFound() throws Exception {
        ...
        mockMvc.perform(post("/employee/clients/1/update")
                        .with(csrf())
